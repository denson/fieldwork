...
The website provides evidence, interactive controls and calculations. The guide discusses the note the learner chooses to share. With Companion Pane 0.8.0 in Chrome split view, Put note in BoodleBox fills the matching empty chat draft; the learner reviews and presses Send. Business Plan First Steps also supports the reverse, user-approved handoff: the guide drafts field wording and **Use this draft** places it in the paired website. Clicked activity links can open the matching website and guide. Copy/paste is available without the extension. Other conversations and unshared clicks do not transfer.
