...
test('cache-busted entrypoints load the upgraded business assets',()=>{
  for(const asset of ['business.css?v=20260915-revisions','business-core.js?v=20260915-revisions','business.js?v=20260915-revisions'])assert.ok(html.includes(asset));
});
