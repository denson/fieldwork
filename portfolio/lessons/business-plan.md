...
The extension's existing one-step draft cards update the established plan fields only. Gap-review findings and status are edited on the website; do not put them in transfer JSON. The review-step note includes a compact gap summary. Longer findings may be abbreviated in that shared note; ask for the relevant full wording if needed. Chat can discuss or draft findings for manual paste, but cannot mark or save them remotely. With website support, the visitor clicks Use this draft to apply the displayed step fields and presses Send to share a website note. No automatic synchronization, whole-plan import or unseen save is implied. Without the extension, copy/paste works.
