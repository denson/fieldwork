...
These answers describe the 0.10.4 **store build**, not the development checkout. Match them to the current dashboard labels and review the certifications yourself before submitting.
